...
<!-- Page 1 -->
<section>
  <div class="jumbotron-fluid" style="background:#3282B8">
      <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner justify-content-center " style="background:">
          ...
          <div class="carousel-item @if($i == 0) {{ 'active' }} @endif justify-content-center">
            <a href="{{ route('link', $artikel->id) }}"><img src="img_artikel/{{$artikel->gambar_artikel}}" class="mx-auto d-block my-3 pb-4" alt="Cinque Terre"  height="400px" width="70%"></a>
...
<section id="page2" class="kegiatan">
  <div class="container pb-5" id="kegiatan" class="kegiatan">
    <div class="row" style="padding-top:50px">
      <div class="col-sm-6 rounded-lg" style="background-color:white">
        <div class="container">
          <h2>POPULER</h2>
          <br>
          <!-- Nav tabs -->
    ...
    <div class="col-sm-6" >
      <div class="container mb-3 py-3 px-3 rounded-lg" style="background-color:white" >
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/pViPQvwXT5w" allowfullscreen></iframe>
        </div>
      </div>

        <div class="container mb-3 py-1 px-3 rounded-lg" width="15%" style="background-color:white">
          <a>Profile</a>
          <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators">
              <li data-target="#carouselExampleCaptions" data-slide-to="0" class="active"></li>
            ...
            <div class="carousel-inner justify-content-center pt-4" style="background:">
              ...
              <div class="carousel-item @if($i == 0) {{ 'active' }} @endif justify-content-center">
                ...
                <p class="carousel-caption text-center font-weight-bold" style="background-color: #3282B8; opacity: 0.8; font-size:25px">{{ str_limit($artikel->nama_artikel, 50)}}</p>
              </div>
              @endforeach
            </div>
...
<section id="page3">
    <div class="container pb-5" id="kegiatan" class="kegiatan">
      <div class="row" style="padding-top:50px; padding-bottom:50px">
        <div class="col-sm-6 rounded-lg pt-5" style="border:2px solid white ;background-color:white">
        <div class="container">
          <!-- Nav tabs -->
          <ul class="nav nav-tabs font-weight-bold" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" data-toggle="tab" href="#menuDownload">DOWNLOAD</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-toggle="tab" href="#menuPSB">PENERIMAAN SANTRI BARU</a>
            </li>
          </ul>
      ...
      <div class="col-sm-6 rounded-lg">
        <div class="jumbotron" style="padding-top:50px; padding-bottom:50px; border:2px solid white ;background-color:white">
          <div class="row">
              <div class="container">
                <div class="row">
                  <div class="card-group">
                    <div href="#" class="card card-link bg-dark text-white mx-1 mb-1 rounded-lg" href="/">
...
<!-- Page 4 karya -->
<section class="kontak" style="padding-top:50px; padding-bottom:50px; background-color:#3282B8">
  <div class="container py-3" >
    <div class="row">
      <div class="col-sm-4 rounded-lg">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe width="100%" height="300" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/612140550&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe>
        </div>
      </div>
      <div class="col-sm-4 rounded-lg">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe width="727" height="409" src="https://www.youtube.com/embed/r6JyyZapQz8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>
      <div class="col-sm-4 rounded-lg">
        <div class="embed-responsive embed-responsive-16by9">
    ...
    <div class="row">
      <div class="col-sm-1">
        <a href="https://www.instagram.com/mahad_universal/" target="_blank">
          <img class="card-img img-thumbnail rounded-circle mx-auto d-block my-4" border="0" title="Facebook" src="img/IG.png" width="40px" height="40px">
        </a>
        <a href="https://web.facebook.com/medkominfoppmu?fref=ts" target="_blank">
          <img class="card-img img-thumbnail rounded-circle mx-auto d-block my-4" border="0" title="Facebook" src="img/FB.png" width="40px" height="40px">
        </a>
        <a href="https://www.youtube.com/channel/UC1jytVi48EdtvqCSpq2w9RQ" target="_blank">
          <img class="card-img img-thumbnail rounded-circle mx-auto d-block my-4" border="0" title="Facebook" src="img/YT.png" width="40px" height="40px">
        </a>
      ...
      <div class="col-sm-6">
        <div class="container text-white font-weight-bold">
          <div class="row pb-4">
            <img src="img/logoPPMU.png" class="card-img img-thumbnail rounded-circle  mx-auto d-block" style="width:100px;height:100px" alt="..." href=" ">
          </div>
          <div class="row">
            Pondok Pesantren Mahasiswa Universal - Jl. Desa Cipadung No. 1 RT 03/08, kelurahan Cipadung, kec. Cibiru, kota Bandung (depan MAN 2 kota Bandung) kode pos 40614
          </div>
