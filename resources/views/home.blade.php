            ...
            <div id="menuBerita" class="container tab-pane active"><br>
                  ...
                  <div class="row pb-2 mb-3 shadow">
                    <div class="col-md-4 text-center">
                      <a href="{{ ($artikel->slug) }}"><img src="img_artikel/{{$artikel->gambar_artikel}}" class="mx-auto d-block my-3 pb-4" alt="Cinque Terre" width="100%"></a>
                    </div>
                    <div class="col-md-8">
                      <div class="card border-white" style="">
                        <div class="card-body text-left ">
                          ...
                          <a href="{{ ($artikel->slug) }}" class="card-link">Selengkapnya</a>
                        </div>
                      </div>
                    </div>
                  </div>
