...
<section id="page2" class="kegiatan" style="background-color:#027cd9">
  <div class="container pb-5" id="kegiatan" class="kegiatan">
    ...
    <div class="col-sm-6" >
        <div class="card mb-3 py-1 px-3 rounded-lg" width="15%" >
          <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators">
              <li data-target="#carouselExampleCaptions" data-slide-to="0" class="active"></li>
              <li data-target="#carouselExampleCaptions" data-slide-to="1"></li>
...
<!-- Page 4 kontak -->
<section class="kontak  bg-dark">
  <div class="container py-3">
    <div class="row">
      <div class="col-sm-1">
          <img src="img/logoPPMU.png" class="card-img img-thumbnail rounded-circle mx-auto d-block mb-3" alt="..." href=" ">
          <img src="img/logoPPMU.png" class="card-img img-thumbnail rounded-circle mx-auto d-block my-4" alt="..." href=" ">
          <img src="img/logoPPMU.png" class="card-img img-thumbnail rounded-circle mx-auto d-block mt-3" alt="..." href=" ">
      </div>
      <div class="col-sm-6">
