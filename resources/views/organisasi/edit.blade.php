...
<h1 class="text-center">EDIT ORGANISASI</h1>
<div class="container" style=" width: 500px; height:300px">
<form action="/organisasi/{{$organisasi->id}}" method="post" enctype="multipart/form-data" style="padding:10px; border:1px solid black">
    ...
    <textarea class="ckeditor" id="isi_organisasi" name="isi_organisasi" rows="5" cols="45">{!!$organisasi->isi_organisasi!!}</textarea>
  </div>
